								...
								<div className="row g-0">
									<div className="col-md-7 col-lg-7 d-flex align-items-center">
										<div className="card-body p-1 p-lg-5">
											<Form>
												...
												<Button style={{padding:'1rem', backgroundColor:'#F14281', width:'140px', height:'52px', fontSize:'14px', fontWeight:'400', borderRadius:'3rem', lineHeight:'20px', color:'white', marginTop:'4rem', border:'none', justifyContent:'none', gap:'1rem'}} onClick={() => dispatch({type:"closeEdit"})} >LOGIN</Button>
									...
									<div className="col-md-5 col-lg-5 d-flex align-items-start">
										<div className="card-body pt-5" style={{marginLeft:'5rem'}}>
											...
											<Button className="btn" style={{padding:'1rem', border: "2px white solid", marginTop: "12rem", width: "140px", height:'52px', lineHeight:'0px', fontSize:'14px', borderRadius:'4rem', backgroundColor:"#107ACC"}}>
											REGISTER</Button>
										</div>                        
									</div>
								</div>
