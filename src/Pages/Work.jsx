      ...
      <div className={`${styles.educationTag}`}>
        ...
        <div>
          ...
          <div className={`${styles.text}`}>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas numquam quis nostrum eligendi deserunt, maiores adipisci ea ipsum cumque illo!</p>
          </div>
        </div>
      </div>
      <div className={`${styles.educationTag}`}>
