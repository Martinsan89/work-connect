...
function UpdateWork(props) {
  ...
  const [stillWorkin, setStillWorkin] = useState(false);
      ...
      >
        ...
        <Form>
            ...
            <div>
                ...
                onClick={() => {
                  dispatch(updateTitle({id: props.id.id, title, subtitle, text, dateInicio, dateFin, stillWorkin})), dispatch(props.onHide)
                }}>UPDATE</Button>
